...
person_model = models.load_model('C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\person_model')
emotion_model = models.load_model('C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\emotion_model')
    ...
    if (filename==None):
        ...
        if(VoiceState.get()==0 and EmotionState.get()==0):
            ...
            if (np.argmax(predictions[0])==0):
                load = Image.open("C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\theodor.jpg")
            elif (np.argmax(predictions[0])==1):
                load = Image.open("C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\andreea.jpg")
            elif (np.argmax(predictions[0])==2):
                load = Image.open("C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\ioana.jpg") 
            elif (np.argmax(predictions[0])==4):
                load = Image.open("C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\adriana.jpg")
            else:
                load = Image.open("C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\anonim.jpg") 
...
def Record():
    ...
    sd.wait() 
    filename="C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\voice_test.wav"
...
def OpenAddOrRemovePage():
    with open('C:\\Users\\tmacovei001\\Desktop\\Speaker Recognition\\Code\\Exe\\Saved Persons','rb') as f:
        y1=pickle.load(f)
